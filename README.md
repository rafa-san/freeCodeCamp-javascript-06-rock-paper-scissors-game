...
# JavaScript Algorithms and Data Structures Certification #06 | Rock, Paper, Scissors Game

## 1️⃣ Objetivo
Criar um jogo de pedra, papel e tesoura (Jokenpô) e revisar conceitos básicos de manipulação do DOM.

## 2️⃣ Descrição
Este é o sexto curso da trilha **JavaScript Algorithms and Data Structures Certification**.

No projeto, você terá a oportunidade de:

- Revisar condicionais e funções;
- Utilizar o método <code>getElementById</code>;
- Resolver pequenos problemas e reforçar fundamentos do JavaScript.

Uma excelente prática para consolidar o básico de forma interativa e divertida.
